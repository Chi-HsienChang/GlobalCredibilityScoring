...
def main():
    folder = "../GCS_scores/Human_ss_score_k_1000"
    a3_df = pd.read_csv("../AS_data/hg19_A3.txt", sep="\t")
    a3_df["index"]    = -1
    a3_df["prob_5ss"] = -1.0
    a3_df["prob_3ss"] = -1.0
    ...
    plt.tight_layout()
    plt.savefig("./A3SS_Human.png", dpi=300)
    print("###### Human (A3SS) ######")
    print(f"r = {r:.2f}\n(p = {p:.2g})")
    print("Figure saved as A3SS_Human.png")
