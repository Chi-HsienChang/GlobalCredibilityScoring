...
def main():
    folder = "../GCS_scores/Arabidopsis_intron_score_k_1000"
    AS_path = "../AS_data/tair10_RI.txt"
    ...
    plt.tight_layout()
    plt.savefig("./RI_Arabidopsis.png", dpi=300)
    print("###### Arabidopsis (RI) ######")
    print("Figure saved as RI_Arabidopsis.png")
