...
def main():
    folder = "../GCS_scores/Human_intron_score_k_1000"
    AS_path = "../AS_data/hg19_RI.txt"
    ...
    ax1.set_xlabel("Human", fontsize=40, fontweight="bold")
    ...
    ax2.plot(x_ri, cdf_ri, label="RI", color="#2E8B57", linewidth=10)
    ax2.plot(x_nonri, cdf_nonri, label="non-RI", color="blue", linewidth=10)
    ...
    ax2.legend(
        ...
        handlelength=0.2,      
        scatterpoints=1,     
        bbox_to_anchor=(1.07, -0.03)
    )

    plt.tight_layout()
    plt.savefig("./RI_Human.png", dpi=300)
    print("###### Human (RI) ######")
    print("Figure saved as RI_Human.png")
