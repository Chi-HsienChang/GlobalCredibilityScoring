...
def main():
    folder = "../GCS_scores/Human_exon_score_k_1000"
    AS_path = "../AS_data/hg19_SE.txt"
    ...
    ax2.plot(x_se,  cdf_se,  label="SE",     color="#2E8B57",   linewidth=10)
    ax2.plot(x_non, cdf_non, label="non-SE", color="blue", linewidth=10)
    ...
    ax2.legend(
        ...
        handlelength=0.2,      
        scatterpoints=1,      
        bbox_to_anchor=(1.07, -0.1)
    )

    plt.tight_layout()
    plt.savefig("./SE_Human.png", dpi=300)
    print("###### Human (SE) ######")
    print("Figure saved as SE_Human.png")
